...
export const en = {
  ...
  oauthDeviceHint: 'Open the link below and enter the code to connect your {provider} account. The token refreshes automatically in the background.',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  oauthConnect: '连接 {provider}',
  oauthConnecting: '等待授权…',
  oauthDeviceTitle: '授权此设备',
  oauthDeviceHint: '打开下方链接并输入代码，即可连接你的 {provider} 账号。令牌将在后台自动续期。',
