...
export const en = {
  ...
  oauthConnect: 'Connect GitHub',
  oauthConnecting: 'Waiting for authorization…',
  oauthDeviceTitle: 'Authorize this device',
  oauthDeviceHint: 'Open the link below and enter the code to connect your GitHub account. The token refreshes automatically in the background.',
  oauthDeviceCode: 'Device code',
  oauthCopyCode: 'Copy',
  oauthCopied: 'Copied',
  oauthConnected: 'Connected — the token refreshes automatically',
  oauthConnectedExpires: 'Connected — refreshes automatically (token expires {time})',
  oauthReconnect: 'Reconnect',
  oauthDisconnect: 'Disconnect',
  oauthCancelLogin: 'Cancel login',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  oauthConnect: '连接 GitHub',
  oauthConnecting: '等待授权…',
  oauthDeviceTitle: '授权此设备',
  oauthDeviceHint: '打开下方链接并输入代码，即可连接你的 GitHub 账号。令牌将在后台自动续期。',
  oauthDeviceCode: '设备代码',
  oauthCopyCode: '复制',
  oauthCopied: '已复制',
  oauthConnected: '已连接 — 令牌自动续期',
  oauthConnectedExpires: '已连接 — 自动续期（令牌 {time} 过期）',
  oauthReconnect: '重新连接',
