...
flowchart LR
  ...
  svc_oauth["ctx.oauth<br/>OAuth provider connections"]
...
| `ctx.oauth` | `core` | [`llm-oauth`](../packages/llm/llm-oauth) | - | [`llm-pi-ai`](../packages/llm/llm-pi-ai) | - | 拥有设备码登录、持久化凭证存储与后台令牌续期；适配器通过凭证接缝消费刷新后的访问令牌。 |
