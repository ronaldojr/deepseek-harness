...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  OauthConnectionView: 'llm-streaming.md',
...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  OauthAccepted: 'Remote acknowledgement contract is owned by packages/llm/llm-oauth/README.md',
  OauthFlow: 'OAuth flow registration contract is owned by packages/llm/llm-oauth/README.md',
  OauthProviderRequest: 'Remote request contract is owned by packages/llm/llm-oauth/README.md',
  OauthResult: 'Remote result contract is owned by packages/llm/llm-oauth/README.md',
