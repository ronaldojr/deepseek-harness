...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/llm/llm-oauth': { kind: 'indirect', reason: 'The service publishes OAuth credentials through the credentials seam; the consuming LLM adapter serializes them into provider requests and owns every model-visible effect.' },
